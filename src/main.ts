...
const COMMANDS = ["help", "about", "projects", "whoami", "repo", "banner", "clear", "sileo", "zebra" ];
const HISTORY : string[] = [];
const SUDO_PASSWORD = command.password;
const REPO_LINK = command.repoLink;
const SILEO_LINK = command.sileoLink;
const ZEBRA_LINK = command.zebraLink;
...
function commandHandler(input : string) {
  ...
  switch(input) {
    ...
    case 'projects':
      ...
      break;
    case 'repo':
      writeLines(["Redirecting to zSaaiq Jailbreak repo...", "<br>"]);
      setTimeout(() => {
    ...
    case 'github':
      ...
      break;
    case 'sileo':
      writeLines(["Redirecting to Sileo...", "<br>"]);
      setTimeout(() => {
        window.open(SILEO_LINK, '_blank');
      }, 500);
      break;
    case 'zebra':
      writeLines(["Redirecting to Zebra...", "<br>"]);
      setTimeout(() => {
        window.open(ZEBRA_LINK, '_blank');
      }, 500);
      break;
    case 'rm -rf':
      if (bareMode) {
